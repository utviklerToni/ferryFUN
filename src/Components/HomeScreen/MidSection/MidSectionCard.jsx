						...
						<div className='short-para header'>
							...
							<div className='short-para'>
								<p style={{ color: 'white' }}>
									...
									location to capture the breathtaking moments without being in a
									crowd then brag about it in style among your peasents.
								</p>
								<br />
							</div>
						...
						<div className='short-para header'>
							...
							<div className='short-para'>
								<p className='text-shadow'>
									...
									couple and all. Choose whoever “fills your wallet and take your
									“Friend” on all your adventure.
								</p>
								<br />
							</div>
